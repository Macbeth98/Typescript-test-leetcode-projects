...
var Model = function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; // Normal Syntax Here
    // get on() {
    ...
    // }
    // A much shorter syntax version of the same
  ...
  Model.prototype.fetch = function () {
    ...
    var id = this.attributes.get('id'); // const id = this.get(id); // can also be used
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts","./Collection":"src/models/Collection.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
  ...
  View.prototype.bindEvents = function (fragment) {
    ...
    var _loop_1 = function _loop_1(eventKey) {
      var _a = eventKey.split(':'),
          eventName = _a[0],
          selector = _a[1]; // ES2015 destruction of array
...
users.fetch(); // import { UserEdit } from "./views/UserEdit";
...
},{"./models/User":"src/models/User.ts","./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
